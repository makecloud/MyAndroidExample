    ...
    class MyAdapter extends PagerAdapter {
        ...
        public MyAdapter() {
            ...
            dataSet.add(new MaterialData(2,
                                         "http://flashmedia.eastday" + ".com/newdate/news/2016-11" +
                                                 "/shznews1125-19.mp4"));
            dataSet.add(new MaterialData(1,
                                         "http://test.yungeshidai" + ".com/material" +
                                                 "/39350fe9bcf2503cf20c96e67c51135b.jpg"));
            dataSet.add(new MaterialData(1,
                                         "http://test.yungeshidai" + ".com/material" +
                                                 "/c4241c6bcb09468d1d8c7d251a1fe3b9.jpg"));
            dataSet.add(new MaterialData(1,
                                         "http://test.yungeshidai" +
                                                 ".com/material/e4f2a39a7afa8aa950f86c82c1ee892e.jpg"));
