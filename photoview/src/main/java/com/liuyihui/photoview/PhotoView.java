...
public class PhotoView extends ImageView {
    ...
    public void setNoZoomMovedYListener(NoZoomMovedYListener noZoomMovedYListener) {
        attacher.setNoZoomMovedYListener(noZoomMovedYListener);
    }

    public void setTouchUpListener(TouchUpLIstener touchUpListener) {
        attacher.setTouchUpListener(touchUpListener);
    }

    public void setResponseHeight(int responseHeight) {
        attacher.setResponseHeight(responseHeight);
    }

    public void setWillBeExit(boolean willBeExit) {
        attacher.setWillBeExit(willBeExit);
    }
}
