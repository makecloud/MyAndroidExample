...
public class SntpClient {
     ...
     */
    public RequestTimeResult requestTime(String host, int timeout) {
        ...
        try {
            ...
            return new RequestTimeResult(false, e.getMessage());
        } finally {
            if (socket != null) {
                socket.close();
            }
        ...
        return new RequestTimeResult(true, "");
    }
    ...
    class RequestTimeResult {
        boolean success;
        String msg;
        public RequestTimeResult(boolean success, String msg) {
