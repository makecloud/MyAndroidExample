package com.liuyihui.iflyvoice;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.liuyihui.iflyvoice.util.EncryptUtil;
...
public class RTASRTest {
    ...
    // appid
    private static final String APPID = "603de991";

    // appid对应的secret_key
    private static final String SECRET_KEY = "e8f9b8f8e081651cf8da143707e7acce";

    //api key
    private static final String API_KEY = "456f23e6df77aa706bb7eff06c290edd";
    ...
    // 音频文件路径
    private static final String AUDIO_PATH = "test_1.pcm";
    ...
    public void mainTest() {
        try {
            while (true) {
                URI url = new URI(BASE_URL + getHandShakeParams(APPID, API_KEY));
    ...
    // 生成握手参数
    public static String getHandShakeParams(String appId, String apiKey) {
