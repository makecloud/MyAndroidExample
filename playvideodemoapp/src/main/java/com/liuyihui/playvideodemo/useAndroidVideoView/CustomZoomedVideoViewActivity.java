 ...
 * 测试自定义可以缩放的videoView
 */
public class CustomZoomedVideoViewActivity extends AppCompatActivity {
    private final String TAG = "VideoViewActivity";
    private FrameLayout frameLayout;
    private VideoView customZoomedVideoView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zoomed_videoview);
        init();
    }

    private void init() {
        frameLayout = findViewById(R.id.frameLayout);
        customZoomedVideoView = new CustomZoomVideoView(this);
        frameLayout.addView(customZoomedVideoView);
        ...
        customZoomedVideoView.setVideoPath(url3);

        //试了很多方式，只能通过自定义view，修改测量尺寸改变
        //customZoomedVideoView.setSize(1080, 500);

        //播放结束回调
        customZoomedVideoView.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            @Override
        ...
        customZoomedVideoView.setOnInfoListener(new MediaPlayer.OnInfoListener() {
            @Override
            public boolean onInfo(MediaPlayer mp, int what, int extra) {
                ...
                /*FrameLayout.LayoutParams lp = (FrameLayout.LayoutParams) customZoomedVideoView
                        .getLayoutParams();
                lp.width = 1080;
                lp.height = 400;
                //lp.gravity = Gravity.CENTER;
                customZoomedVideoView.setLayoutParams(lp);*/
                return false;
            }
        });

        customZoomedVideoView.setOnErrorListener(new MediaPlayer.OnErrorListener() {
            @Override
    ...
    public void getInfo(View view) {
        //查看
        Log.d(TAG, "getInfo: isPlaying:" + customZoomedVideoView.isPlaying());
    }

    public void seekTo(View view) {
        customZoomedVideoView.seekTo(0);
        Log.d(TAG, "seekTo: 0");
