...
import com.liuyihui.playvideodemo.customerView.SmoothSwitchIjkVideoView;
 ...
 * 测试ijk view平滑切换视频
 */
public class TestSwitchIjkViewActivity extends AppCompatActivity {
    private final static String TAG = "IjkPLayerActivity";

    public IjkMediaPlayer ijkPlayer;
    public MediaController mediaController;
    public SmoothSwitchIjkVideoView ijkVideoView;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_test_switch_ijk_view);
        ...
        ijkVideoView.setTotalPlayerListener(new TotalVideoPlayerListener() {
            @Override
...
//        String videoUrl = "http://test.yungeshidai.com/material/eec76c455d081e4498c0ad7a55fb67e1.mp4";//test line
        ...
        ijkPlayer._prepareAsync();
    }

    public void switchSrc(View view) {
        String path = "/sdcard/oohlink/player/.screen/0A638DE2475566D0691CECD3F00B19D3";
        ijkVideoView.setNewPath();
    }
