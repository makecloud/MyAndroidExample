...
public class CrashHandler implements Thread.UncaughtExceptionHandler {
    ...
    public static String TAG = "cloud.CrashHandler";
    ...
    public static String getGlobalpath() {
        return Environment.getExternalStorageDirectory().getAbsolutePath() + "/" + ContextUtil.getContext().getPackageName() + File.separator + "crash" + File.separator;
    }
    ...
    private boolean handleException(Throwable ex) {
        ...
        try {
            ...
            new Thread() {
                ...
                public void run() {
                    Looper.prepare();
                    Toast.makeText(mContext, "很抱歉,程序未知异常", Toast.LENGTH_SHORT).show();
                    Looper.loop();
                }
            }.start();
            // 收集设备参数信息
