package com.liuyihui.client.myexample.example8_choose_city_demo;
 ...
 * 城市选择 Activity
 */
public class ChoseCityActivity extends AppCompatActivity implements AbsListView.OnScrollListener, AMapLocationListener {
    public final static String TAG = "ChoseCityActivity";
...
//        mLocationClient.start();
    ...
    private class ResultListAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            viewHolder.name.setText(results.get(i).getName());
            return view;
        }
...
//                            InitLocation();
    ...
    private void initOverlay() {
        ...
        WindowManager.LayoutParams lp = new WindowManager.LayoutParams(WindowManager.LayoutParams.WRAP_CONTENT, WindowManager.LayoutParams.WRAP_CONTENT, WindowManager
                .LayoutParams.TYPE_APPLICATION, WindowManager.LayoutParams.FLAG_NOT_FOCUSABLE | WindowManager.LayoutParams.FLAG_NOT_TOUCHABLE, PixelFormat.TRANSLUCENT);
